    ...
    public function generate() {
        ...
        foreach ($this->query->result_array() as $result_db) {
            ...
            foreach ($this->column as $row) {
               ...
               /* $this->getActiveSheet()->getStyle('A')->getNumberFormat()->setFormatCode('@');
                $this->getActiveSheet()->getStyle('B')->getNumberFormat()->setFormatCode('@');           
                $this->getActiveSheet()->getStyle('C')->getNumberFormat()->setFormatCode('@');
                $this->getActiveSheet()->getStyle('E')->getNumberFormat()->setFormatCode('@');
                $this->getActiveSheet()->getStyle('AQ')->getNumberFormat()->setFormatCode('@');*/
